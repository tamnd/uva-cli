...
Most of these come down to network reality or how uva serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

uva rate-limits like any public site. uva already paces
...
Where a surface is gated, uva reads a cookie or token you supply
...
`uva`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what uva actually did
