// Package cli builds the uva command tree on top of the uva library.
package cli
...
func Root() *cobra.Command {
	app := &App{cfg: uva.DefaultConfig()}

	root := &cobra.Command{
		Use:           "uva",
		Short:         "Browse UVa Online Judge problems",
		SilenceUsage:  true,
		SilenceErrors: true,
